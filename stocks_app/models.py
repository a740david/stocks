...
class Stock(models.Model):
    ...
    pe_ratio = models.DecimalField(db_column='P/E ratio', max_digits=6, decimal_places=2, null=True,blank=True)
...
class Reports(models.Model):
    ...
    revenue = models.DecimalField(db_column='revenue',max_digits=10, decimal_places=2 ,null=False)
